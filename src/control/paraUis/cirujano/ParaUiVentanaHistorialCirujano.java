...
public class ParaUiVentanaHistorialCirujano extends VentanaHistorialCirujano {
	...
	private void crearListaIntervencionesPendientes() {
		this.setIntervencionesPendientes(
				(new JList<String>(this.getControl().obtenerIntervencionesPendientesCirujano(this.getIdCirujano()))));
		...
		this.getPanelHistorialCirujano().add(this.getScrollListaIntervencionesPendientes());
	}

	private void crearListaIntervencionesRealizadas() {
		this.setIntervencionesRealizadas(
				(new JList<String>(this.getControl().obtenerIntervencionesRealizadasCirujano(this.getIdCirujano()))));
		...
		this.getScrollListaIntervencionesRealizadas().setBounds(20, 268, 260, 140);
		this.getScrollListaIntervencionesRealizadas().setBorder(new LineBorder(new Color(0, 102, 204), 2));
		this.getPanelHistorialCirujano().add(this.getScrollListaIntervencionesRealizadas());
	}
